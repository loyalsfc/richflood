...
function Project({title, industry, project, service, backgroundImage}) {
    return (
        <div className='w-full h-[540px] text-white flex flex-col justify-between bg-no-repeat bg-cover px-6 py-12 md:p-12 transition-all hover:scale-110 ease-in-out duration-500' style={{backgroundImage: `url(${backgroundImage})`}}>
            <div />
            <h3 className='text-2xl md:text-[30px] font-bold text-center'>{title}</h3>
            <ul>
